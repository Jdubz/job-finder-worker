...
export const queueItemSchema = z
  .object({
    ...
    scrape_config: z.record(z.unknown()).nullable().optional(),
    scraped_data: z.record(z.unknown()).nullable().optional(),
    source_discovery_config: z.record(z.unknown()).nullable().optional(),
    source_id: z.string().nullable().optional(),
    source_type: z.string().nullable().optional(),
    source_config: z.record(z.unknown()).nullable().optional(),
    source_tier: z.string().nullable().optional(),
    pipeline_state: z.record(z.unknown()).nullable().optional(),
