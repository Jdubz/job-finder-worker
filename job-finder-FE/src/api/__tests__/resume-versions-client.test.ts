...
describe('ResumeVersionsClient', () => {
  ...
  describe('createItem', () => {
    it('posts a new resume item', async () => {
      ...
      const result = await client.createItem('frontend', { title: 'Skills' } as any)
  ...
  describe('updateItem', () => {
    it('patches a resume item', async () => {
      ...
      const result = await client.updateItem('frontend', '1', { title: 'Updated' } as any)
  ...
  describe('createVersion', () => {
    it('posts a new version', async () => {
      ...
      const result = await client.createVersion({ slug: 'ai', name: 'AI Engineer' } as any)
