...
| MIG-004 | Swap frontend to consume the Node API (remove direct Firestore usage, add polling/WebSocket plan). | @frontend | 2025-12-18 | Not Started |
...
| MIG-006 | Automate nightly SQLite backups + off-site sync, document restore drill. | @platform | 2025-12-09 | Not Started |
