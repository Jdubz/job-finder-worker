...
## Status
Implementation is shipped in the worker (single-pass `CompanyProcessor.process_company`), shared types, API queue endpoints, and FE queue UI. Remaining work: none. Keep this doc as an architectural reference; future changes should go in queue-decision-tree.md or new RFCs.
