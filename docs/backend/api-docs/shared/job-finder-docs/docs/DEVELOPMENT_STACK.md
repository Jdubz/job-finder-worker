...
⚠️ **Warning**: Be careful when testing against production!
...
- Review [Architecture Documentation](./architecture/SYSTEM_ARCHITECTURE.md)
- Check [Workflow Processes](./processes/WORKFLOW_PROCESSES.md)
- Read [Project Management Guide](./processes/PROJECT_MANAGEMENT.md)
...
2. Review repo-specific README files
3. Check service status: `make status`
4. Contact the PM or relevant worker
