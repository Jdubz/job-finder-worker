...
- [`sqlite-migration.md`](./sqlite-migration.md) – Firestore → SQLite persistence plan (schema mapping, adapters, Watchtower validation).
...
1. Create a Markdown file with a descriptive name (e.g., `sqlite-cutover-plan.md`).
